...
#    }
    ...
    def __init__(self, fert, mort, mig):
        ...
        self.male_filename = PopProjection.base_dir+"national/males.csv"
        self.female_filename = PopProjection.base_dir+"national/females.csv"
        ...
        if PopProjection.partial_subnat:
            ...
            self.subnat_file_f += "sub-national/full_csv/subnational_projection-female.csv"
            self.subnat_file_m += "sub-national/full_csv/subnational_projection-male.csv"
            self.sub_cc_file_f += "sub-national/full_csv/subnat_components_of_change_f.csv"
            self.sub_cc_file_m += "sub-national/full_csv/subnat_components_of_change_m.csv"

        # Age-specific fertility/mortality rates (asfr/asmr)
        self.asfr_file = PopProjection.base_dir+"national/fert_rate.csv"
        self.asmr_file_m = PopProjection.base_dir+"national/mort_males.csv"
        self.asmr_file_f = PopProjection.base_dir+"national/mort_females.csv"

        # Components of change (for scaling)
        self.cc_file_m = PopProjection.base_dir+"national/components_of_change_m.csv"
        self.cc_file_f = PopProjection.base_dir+"national/components_of_change_f.csv"
